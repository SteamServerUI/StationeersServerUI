...
<section class="settings-hub">
  ...
  {:else if !category && !query}
    <div class="category-grid surface">
      {#each categories as group}
        <button class="category-card" onclick={()=>category=group}>
