...
func SetupV7APIRoutes() (*http.ServeMux, *http.ServeMux) {
	...
	public.HandleFunc("/api/v3/auth/login", httpauth.SessionLoginHandler)
	public.HandleFunc("/api/v3/auth/desktop/login", httpauth.DesktopLoginHandler)
	public.HandleFunc("/api/v3/auth/logout", httpauth.SessionLogoutHandler)
	public.HandleFunc("/api/v3/auth/setup/status", httpauth.SetupStatusHandler)
	public.HandleFunc("/api/v3/auth/setup/bootstrap", httpauth.BootstrapOwnerHandler)
	...
	protect(protected, "/api/v3/loader/reloadbackend", security.PermissionBackendReload, HandleReloadBackend)
	protect(protected, "/api/v3/streams/console", security.PermissionLogsView, sseapi.GetLogOutput)
	protect(protected, "/api/v3/streams/events", security.PermissionLogsView, sseapi.GetEventOutput)
	protect(protected, "/api/v3/streams/logs/debug", security.PermissionLogsView, sseapi.GetDebugLogOutput)
	protect(protected, "/api/v3/streams/logs/info", security.PermissionLogsView, sseapi.GetInfoLogOutput)
	protect(protected, "/api/v3/streams/logs/warn", security.PermissionLogsView, sseapi.GetWarnLogOutput)
	protect(protected, "/api/v3/streams/logs/error", security.PermissionLogsView, sseapi.GetErrorLogOutput)
	protect(protected, "/api/v3/streams/logs/backend", security.PermissionLogsView, sseapi.GetBackendLogOutput)
	...
	protect(protected, "/api/v3/SSCM/run", security.PermissionSSCMRun, sscmapi.HandleCommand)
	protect(protected, "/api/v3/SSCM/enabled", security.PermissionSettingsView, sscmapi.HandleIsSSCMEnabled)
	protect(protected, "/api/v3/steamcmd/run", security.PermissionSteamCMDRun, HandleRunSteamCMD)
	protect(protected, "/api/v3/custom-detections", security.PermissionSettingsManage, detectionmgr.HandleCustomDetection)
	protect(protected, "/api/v3/custom-detections/delete/", security.PermissionSettingsManage, detectionmgr.HandleDeleteCustomDetection)

	protected.HandleFunc("/api/v3/auth/session", httpauth.SessionInfoHandler)
	protected.HandleFunc("/api/v3/auth/desktop/logout", httpauth.DesktopLogoutHandler)
	protected.HandleFunc("/api/v3/auth/whoami", httpauth.SessionInfoHandler)
	protect(protected, "/api/v3/auth/users", security.PermissionUsersManage, httpauth.UsersHandler)
	protect(protected, "/api/v3/auth/users/", security.PermissionUsersManage, httpauth.UserHandler)
	protect(protected, "/api/v3/auth/groups", security.PermissionGroupsManage, httpauth.GroupsHandler)
	protect(protected, "/api/v3/auth/groups/", security.PermissionGroupsManage, httpauth.GroupHandler)
	protect(protected, "/api/v3/auth/tokens", security.PermissionOwnTokensManage, httpauth.TokensHandler)
	protect(protected, "/api/v3/auth/tokens/", security.PermissionOwnTokensManage, httpauth.TokenHandler)
	...
	protect(protected, "/api/v3/runfile/args/getarg", security.PermissionRunfilesView, runfileapi.HandleRunfileGetArg)
	protect(protected, "/api/v3/runfile/meta", security.PermissionRunfilesView, runfileapi.HandleRunfileGetMeta)
	protect(protected, "/api/v3/runfile/args/update", security.PermissionRunfilesManage, runfileapi.HandleRunfileArgUpdate)
	protect(protected, "/api/v3/runfile/save", security.PermissionRunfilesManage, runfileapi.HandleRunfileSave)
	...
	protect(protected, "/api/v3/osstats", security.PermissionServerView, sysinfoapi.HandleGetOsStats)
	protect(protected, "/api/v3/overview", security.PermissionServerView, HandleOverview)
	...
	if config.GetPluginsEnabled() {
		...
		protect(protected, "/api/v3/plugins/list/apiroutes", security.PermissionPluginsView, pluginsapi.HandleListPluginAPIRoutes)
		protect(protected, "/api/v3/plugins/list/names", security.PermissionPluginsView, pluginsapi.HandleListPluginNames)
		protect(protected, "/api/v3/plugins/stop", security.PermissionPluginsManage, pluginsapi.HandleStopPlugin)
	} else {
		protected.HandleFunc("/api/v3/plugingallery", pluginsDisabled)
		protected.HandleFunc("/api/v3/plugingallery/select", pluginsDisabled)
		protected.HandleFunc("/api/v3/plugins/", pluginsDisabled)
	}

	protect(protected, "/api/v3/backup/create", security.PermissionBackupsCreate, backupapi.HandleBackupCreate)
