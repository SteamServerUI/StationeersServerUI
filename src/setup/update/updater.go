...
// CheckForUpdates checks for the latest release from GitHub. If called with isInUpdateableState set to true, it will automatically apply the update if the current version is not up-to-date.
